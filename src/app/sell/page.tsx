...
function SellChat() {
  ...
  return (
    <div className="flex flex-col h-screen max-w-lg mx-auto px-4">
      ...
      {/* Floating deal card (top-right) */}
      {dealLink && (
        <div className="fixed top-4 right-4 w-64 bg-green-50 border border-green-200 rounded-2xl p-3 space-y-2 shadow-lg z-50 animate-[slideInRight_0.3s_ease-out]">
          <p className="text-xs font-semibold text-green-800">Your deal link</p>
          <div className="bg-white rounded-lg px-2 py-1.5 text-xs font-mono text-zinc-600 break-all">
            {dealLink}
          </div>
          <button
            onClick={copyLink}
            className="w-full h-8 rounded-lg bg-green-500 text-white text-xs font-semibold flex items-center justify-center gap-1.5 hover:bg-green-600 transition-colors"
          >
          ...
          <div className="flex gap-1.5">
            <button
              ...
              className="flex-1 h-8 rounded-lg bg-[#1877F2] text-white flex items-center justify-center hover:bg-[#1565C0] transition-colors"
            ...
            <button
              onClick={() => shareTo("x")}
              className="flex-1 h-8 rounded-lg bg-black text-white flex items-center justify-center hover:bg-zinc-800 transition-colors"
              title="Share on X"
            >
            ...
            <button
              ...
              className="flex-1 h-8 rounded-lg bg-[#FF4500] text-white flex items-center justify-center hover:bg-[#E03D00] transition-colors"
            ...
            <button
              ...
              className="flex-1 h-8 rounded-lg bg-[#25D366] text-white flex items-center justify-center hover:bg-[#1DA851] transition-colors"
