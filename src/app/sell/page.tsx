      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-4">
        ...
        {!dealLink ? (
          ...
          <div className="w-full bg-green-50 border border-green-200 rounded-2xl p-4 space-y-3">
            ...
            <button
              onClick={copyLink}
              className="w-full h-10 rounded-xl bg-green-500 text-white text-sm font-semibold flex items-center justify-center gap-2 hover:bg-green-600 transition-colors"
            >
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 h-10 rounded-xl bg-[#1877F2] text-white text-sm font-semibold flex items-center justify-center gap-1.5 hover:bg-[#1565C0] transition-colors"
              >
              ...
              <button
                onClick={() => shareTo("x")}
                className="flex-1 h-10 rounded-xl bg-black text-white text-sm font-semibold flex items-center justify-center gap-1.5 hover:bg-zinc-800 transition-colors"
              >
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 h-10 rounded-xl bg-[#FF4500] text-white text-sm font-semibold flex items-center justify-center gap-1.5 hover:bg-[#E03D00] transition-colors"
              >
              ...
              <button
                ...
                className="flex-1 h-10 rounded-xl bg-[#25D366] text-white text-sm font-semibold flex items-center justify-center gap-1.5 hover:bg-[#1DA851] transition-colors"
              >
